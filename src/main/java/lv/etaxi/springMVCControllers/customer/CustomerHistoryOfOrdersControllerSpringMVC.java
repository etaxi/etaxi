...
@Controller
public class CustomerHistoryOfOrdersControllerSpringMVC {
    ...
    @RequestMapping(value = "/customer/customerHistoryOfOrders", method = {RequestMethod.GET})
    public ModelAndView processGetRequest(HttpServletRequest request, HttpServletResponse response) {
        ...
        return new ModelAndView("/customer/CustomerListOrders", "model", new MVCModel(null, null, ""));
    }

    @RequestMapping(value = "/customer/customerHistoryOfOrders", method = {RequestMethod.POST})
    public ModelAndView processPostRequest(HttpServletRequest request, HttpServletResponse response) throws SQLException {
        ...
        List<Order> listOfOrders = orderManagerImpl.getOrdersByCustomerId(
                currentCustomerDTO.getCustomerId(),
                orderedDateTimeBegin,
                orderedDateTimeEnd);

        List<OrderDTO> listOfOrdersDTO = convertorDTO.convertOrderListToDTOList(listOfOrders);
        return new ModelAndView("/customer/CustomerListOrders", "model", new MVCModel(null, listOfOrdersDTO, ""));
    }
