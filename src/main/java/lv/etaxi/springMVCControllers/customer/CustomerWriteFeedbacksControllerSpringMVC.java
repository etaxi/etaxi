...
@Controller
public class CustomerWriteFeedbacksControllerSpringMVC {
    ...
    @RequestMapping(value = "/customer/customerWriteFeedbacksToOrders", method = {RequestMethod.GET})
    public ModelAndView processGetRequest(HttpServletRequest request, HttpServletResponse response) {
        ...
        return new ModelAndView("/customer/CustomerWriteFeedbacksToOrders", "model", new MVCModel(null, null, ""));
    }

    @RequestMapping(value = "/customer/customerWriteFeedbacksToOrders", method = {RequestMethod.POST})
    public ModelAndView processPostRequest(HttpServletRequest request, HttpServletResponse response) throws SQLException {
        ...
        return new ModelAndView("/customer/CustomerWriteFeedbacksToOrders", "model", new MVCModel(null, listOfOrdersDTO, ""));
    }
